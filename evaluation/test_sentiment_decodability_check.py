...
class DecodabilityTests(unittest.TestCase):
    def test_signal_is_decodable_and_beats_permutation(self):
        ...
        out = plain_decodability(X, y, g, n_splits=4, n_permutations=50, seed=1)
    ...
    def test_noise_is_at_chance(self):
        ...
        out = plain_decodability(X, y, g, n_splits=4, n_permutations=50, seed=2)
    ...
    def test_permutation_chance_near_analytic(self):
        ...
        out = plain_decodability(X, y, g, n_splits=4, n_permutations=80, seed=3)
    ...
    def test_feasible_splits_capped_by_group_support(self):
        ...
        out = plain_decodability(X, y, g, n_splits=99, n_permutations=10, seed=5)
    ...
    def test_length_mismatch_raises(self):
        ...
        with self.assertRaises(ValueError):
            plain_decodability(X, y[:-1], g, n_permutations=5)
